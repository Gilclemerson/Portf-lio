const quizQuestions = [
  ...
  {
    question: " O que o acento circunflexo (^) indica e qual sua principal diferença em relação ao agudo?",
    answers: [
  ...
  {
    question: " Para que serve o acento diferencial e o que mudou com o Novo Acordo Ortográfico na palavra 'pára'?",
    answers: [
